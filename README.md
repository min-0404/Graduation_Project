...
### Ver. 2.3 (2022/06/14)
- Adding comments to the code for better comprehension of the service one logic

### Ver. 2.2 (2022/06/11)
- Fixing “service one” page refresh error (first try)

### Ver. 2.1 (2022/06/01)
- Adding comments to the code for better comprehension

### Ver. 2.0 (2022/05/31)
- implementing Server to Server communication between the Spring and Flask servers

### Ver. 1.7 (2022/05/20)
- new API functions on the Benefit controller class for the first recommendation service

### Ver. 1.6 (2022/05/13)
- Messenger class (DTO) for Server to Server communication

### Ver. 1.5 (2022/05/12)
- Individual card info API completed + Adding new Repository functions for future logics

### Ver. 1.4 (2022/05/10)
- [Delete src/main/java/Graduation/CardVisor/Repository directory](https://github.com/min-0404/Graduation_Project/commit/09f7a495a4879452da97cc1d1fed9a394288ecfa)**

### Ver. 1.3 (2022/05/09)
- Functions for the controller to complete the cardinfo API

### Ver. 1.2 (2022/04/29)
- Making of the logic functions for Individual card info pages

### Ver. 1.2 (2022/04/28)
- Adding repository interfaces following the ERD structure

### Ver. 1.1 (2022/04/27)
- Adding domain classes following the ERD structure
