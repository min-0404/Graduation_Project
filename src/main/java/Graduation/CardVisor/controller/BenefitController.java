...
public class BenefitController {
    ...
    // method: post 로 받을 시 꼭 붙여줄 것
    @PostMapping("/select")
    public Map<String, Object> getSelections(@RequestBody List<ServiceOneDto> list) { // [{"memberId" : 1, "brandName": transport_bus}, {}, {}...] 형식으로 담겨져옴
        return benefitService.dtoToRecommendedCards(list);
    }
